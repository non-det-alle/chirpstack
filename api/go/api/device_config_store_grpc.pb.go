...
func (c *deviceConfigStoreServiceClient) Set(ctx context.Context, in *SetDeviceConfigStoreRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, DeviceConfigStoreService_Set_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceConfigStoreServiceClient) Get(ctx context.Context, in *GetDeviceConfigStoreRequest, opts ...grpc.CallOption) (*GetDeviceConfigStoreResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeviceConfigStoreService_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceConfigStoreServiceClient) Delete(ctx context.Context, in *DeleteDeviceConfigStoreRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, DeviceConfigStoreService_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceConfigStoreServiceClient) List(ctx context.Context, in *ListDeviceConfigStoresRequest, opts ...grpc.CallOption) (*ListDeviceConfigStoresResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeviceConfigStoreService_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceConfigStoreServiceClient) GetConfigStoreAlignment(ctx context.Context, in *GetConfigStoreAlignmentRequest, opts ...grpc.CallOption) (*GetConfigStoreAlignmentResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeviceConfigStoreService_GetConfigStoreAlignment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceConfigStoreServiceClient) GetAvailableUplinkChannels(ctx context.Context, in *GetAvailableChannelsRequest, opts ...grpc.CallOption) (*GetAvailableChannelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeviceConfigStoreService_GetAvailableUplinkChannels_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedDeviceConfigStoreServiceServer must be embedded to have
...
func (UnimplementedDeviceConfigStoreServiceServer) testEmbeddedByValue() {}
...
func RegisterDeviceConfigStoreServiceServer(s grpc.ServiceRegistrar, srv DeviceConfigStoreServiceServer) {
	// If the following call pancis, it indicates UnimplementedDeviceConfigStoreServiceServer was
