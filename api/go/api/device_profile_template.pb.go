...
type DeviceProfileTemplate struct {
	...
	// ChMask algorithm ID.
	ChmaskAlgorithmId string `protobuf:"bytes,30,opt,name=chmask_algorithm_id,json=chmaskAlgorithmId,proto3" json:"chmask_algorithm_id,omitempty"`
}
...
func (x *DeviceProfileTemplate) GetChmaskAlgorithmId() string {
	if x != nil {
...
var file_api_device_profile_template_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xea, 0x0b, 0x0a, 0x15, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72,
	...
	0x65, 0x6e, 0x74, 0x73, 0x12, 0x2e, 0x0a, 0x13, 0x63, 0x68, 0x6d, 0x61, 0x73, 0x6b, 0x5f, 0x61,
	0x6c, 0x67, 0x6f, 0x72, 0x69, 0x74, 0x68, 0x6d, 0x5f, 0x69, 0x64, 0x18, 0x1e, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x11, 0x63, 0x68, 0x6d, 0x61, 0x73, 0x6b, 0x41, 0x6c, 0x67, 0x6f, 0x72, 0x69, 0x74,
	0x68, 0x6d, 0x49, 0x64, 0x1a, 0x37, 0x0a, 0x09, 0x54, 0x61, 0x67, 0x73, 0x45, 0x6e, 0x74, 0x72,
